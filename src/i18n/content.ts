export const content = {
    de: { // 독일어 (de)
      ...
      "bankInfo": "Bitte überweisen Sie die Gebühr an das folgende Konto: [Bankname, Kontonummer, etc.]",
    ...
    en: { // 영어 (en)
      ...
      "bankInfo": "Please transfer the fee to the following account: [Bank Name, Account Number, etc.]",
