export const content = {
    de: { // 독일어 (de)
      ...
      "presentationSectionRequirement": "Bitte geben Sie im Formular unbedingt an, in welcher Sektion Sie vortragen möchten.",
      "presentationSameAsSectionNotice": "Die weiteren Angaben orientieren sich am Formular für die Sektionsleitung.",
    ...
    en: { // 영어 (en)
      ...
      "presentationSectionRequirement": "Please make sure to indicate in the form which section you wish to present in.",
      "presentationSameAsSectionNotice": "All other details should follow the section application form.",
